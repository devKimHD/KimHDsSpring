  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link"  href="/message/receive">
          <i class="far fa-comments"></i>
          <span class="badge badge-danger navbar-badge">${msgNoReadCount}</span>
        </a>
...
<!--         </div> -->
      ...
      <li class="nav-item dropdown">
        <a class="nav-link"  href="#">
          ...
          <span class="badge badge-warning navbar-badge">point</span>
        </a>
<!--         <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right"> -->
...
<!--         </div> -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      ...
      <span class="brand-text font-weight-light">스프링 게시판</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/board/list?page=1" class="nav-link active">
